...
while len(houses)!=0:
    ...
    for house in houses: 
        ...
        if mat[x][y].value == 0 and (mat[x+1][y].value !=0  or mat[x][y+1].value !=0 or mat[x-1][y].value !=0 or mat[x][y-1].value !=0):
            mat[x][y] = house
            #print("já jsem postavil D1")
            house.zarid_cestu()
